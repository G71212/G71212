...
**🤖 AI Home/Away** (a tab on the dashboard): type how many predictions you want, choose home and away wins, home wins only or away wins only, and press **Generate**. The AI scans every match of the selected day with the prediction model and lists the most likely home or away wins, with probability, fair and bookmaker odds, a short "why" (model vs bookmakers, expected goals) and ✓/✕ once played; on the Yesterday tab it shows how the picks did. It runs on your phone, needs no key, and never changes the four markets' picks or the track record. In backtests (14,930 matches, Aug 2024 – Jun 2026) its picks were well calibrated: rated 75%+ they won 83%, 65–75% won 71%, 55–65% won 60%, and a day's top 10 won 62%. A draw beats both sides, so these are riskier than Double Chance.
