...
def test_opening_shows_the_golden_g_ball_and_the_welcome():
    ...
    assert 'class="player"' in splash and "Tap to skip" in splash  # the kick, and a way out of it
    assert "function digitRain" in page  # the green digits that follow the kick
    rep["welcome"] = ""
